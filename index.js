...
const getTopTracks = async () => {
  try {
    const {
      ...
      "https://spotify-web2.p.rapidapi.com/playlist_tracks/",
      {
        params: {
        ...
        headers: {
          "X-RapidAPI-Key": "b2fd7811a0msha2d668dfd2c45bap100a30jsn22bc61f46071",
